...
3. **Configure environment:**
   ...
   - Add your MongoDB connection URI to the `.env` file as follows:
     ```env
     MONGODB_URI=mongodb://<your-mongodb-host>:<port>/<your-db-name>(link from mongo db connection string)
     ```
...
- Can use NLP to parse faster when text is unstructured but it is not necessary in this case.
